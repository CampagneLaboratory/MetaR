# Generated with MetaR, http://metaR.campagnelab.org, from script "UNHumanDevelopmentReport" on Sat Jun 24 16:35:01 EDT 2017
...
data.dir<-"/Users/fac2003/MPSProjects/git/metar/data"
dat<-read.csv(file.path(data.dir,"IR-demo","EconomistData.csv"))
pc1<-ggplot(dat,aes(x=CPI,y=HDI,color=Region))
save.image("/Users/fac2003/R_RESULTS/instantRefresh/YFPYTYFBVO.Rda", safe = FALSE);
...
pc3$data<-dat
save.image("/Users/fac2003/R_RESULTS/instantRefresh/LNNWUHSFTE.Rda", safe = FALSE);
...
grid.text(paste0("This is instant refresh!"),x="0.60",y="0.8",gp=gpar(col="black",fontsize=30),draw="TRUE",just="left")}
tryCatch({ 
png("/Users/fac2003/R_RESULTS/instantRefresh/plot_MQNJCNTSAE_1.png",width=800,height=600)
plot_MQNJCNTSAE()
...
png(file="/Users/fac2003/R_RESULTS/instantRefresh/plot_JWUNTJMJBG_1.png", width=800.0, height=600.0)

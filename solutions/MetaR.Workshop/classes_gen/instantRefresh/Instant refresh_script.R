...
load("/Users/fac2003/R_RESULTS/instantRefresh/LNNWUHSFTE.Rda")
...
, warning = function(w) {
cat(paste("Node STATEMENT_EXECUTED/LMCRNMYHYM/ generated the following warning: ",w,"\n"));
}
, error = function(e) {
cat(paste("Node STATEMENT_EXECUTED/LMCRNMYHYM/ generated the following error: ",e,"\n"));
stop();
}
, finally = {
cat("STATEMENT_EXECUTED/LMCRNMYHYM/\n");
}
)

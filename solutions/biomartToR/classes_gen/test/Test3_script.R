...
queryBiomart_XWIEQQSKJB<- function(){
...
queryBiomart_XWIEQQSKJB()->resultFromBioMart;
...
, warning = function(w) {
cat(paste("Node STATEMENT_EXECUTED/XWIEQQSKJB/ generated the following warning: ",w,"\n"));
}
, error = function(e) {
cat(paste("Node STATEMENT_EXECUTED/XWIEQQSKJB/ generated the following error: ",e,"\n"));
stop();
}
, finally = {
cat("STATEMENT_EXECUTED/XWIEQQSKJB/\n");
}
)

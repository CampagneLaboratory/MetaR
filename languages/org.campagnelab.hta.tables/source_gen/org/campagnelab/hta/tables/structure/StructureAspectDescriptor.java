...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 32:
        return new ConceptDescriptorBuilder("org.campagnelab.hta.tables.structure.Render").super_("org.campagnelab.hta.tables.structure.Statement").parents("org.campagnelab.hta.tables.structure.Statement").properties("filename").references("plot").children(new String[]{"output"}, new boolean[]{false}).alias("render", "Render plot to output format").create();
      case 33:

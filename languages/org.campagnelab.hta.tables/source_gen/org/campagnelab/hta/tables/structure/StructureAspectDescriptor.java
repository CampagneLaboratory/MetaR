...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 12:
        return new ConceptDescriptorBuilder("org.campagnelab.hta.tables.structure.FitXByY").super_("org.campagnelab.hta.script.structure.Statement").parents("org.campagnelab.hta.script.structure.Statement").references("table", "x", "y").children(new String[]{"plot"}, new boolean[]{false}).alias("fit x by y", "fit a linear model and show an annotated plot of the fit").create();
      case 13:

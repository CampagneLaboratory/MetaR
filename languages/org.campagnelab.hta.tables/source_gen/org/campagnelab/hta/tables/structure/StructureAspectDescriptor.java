...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 15:
        return new ConceptDescriptorBuilder("org.campagnelab.hta.tables.structure.ImportTable").super_("org.campagnelab.hta.script.structure.Statement").parents("org.campagnelab.hta.script.structure.Statement").references("table").children(new String[]{"future"}, new boolean[]{false}).alias("import table", "").create();
      case 16:

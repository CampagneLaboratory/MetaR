  ...
  protected Map<String, ReferenceConstraintsDescriptor> getNotDefaultReferences() {
    ...
    references.put("x", new BaseReferenceConstraintsDescriptor("x", this) {
      ...
      public void onReferenceSet(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
        ...
        SLinkOperations.setTarget(referenceNode, "", SLinkOperations.getTarget(ListSequence.fromList(SNodeOperations.getDescendants(SNodeOperations.getAncestor(referenceNode, "org.campagnelab.hta.script.structure.Script", false, false), "org.campagnelab.hta.tables.structure.ImportTable", false, new String[]{})).findFirst(new IWhereFilter<SNode>() {

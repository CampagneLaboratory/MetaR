...
import org.campagnelab.hta.tables.behavior.TableRef_Behavior;
    ...
    if (!(TableRef_Behavior.call_hasGroup_4140623938104765280(SLinkOperations.getTarget(heatmap, "table", true), "ID"))) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(heatmap, "table", true), "Source table must have a column labeled with group ID", "r:ccfe7aab-49c3-4336-8a96-a894ec9d0e17(org.campagnelab.hta.tables.typesystem)", "4140623938104720275", null, errorTarget);
      }
    }
    if (!(TableRef_Behavior.call_hasGroupWithIntent_4140623938104897834(SLinkOperations.getTarget(heatmap, "table", true), "heatmap"))) {
      {
        MessageTarget errorTarget = new NodeMessageTarget();
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(SLinkOperations.getTarget(heatmap, "table", true), "Source table must some columns labeled with a group with usage intent: heatmap", "r:ccfe7aab-49c3-4336-8a96-a894ec9d0e17(org.campagnelab.hta.tables.typesystem)", "4140623938105060774", null, errorTarget);
      }
    }
  }

...
public class ApplyGroup_Intention implements IntentionFactory {
  ...
  public String getPersistentStateKey() {
    return "org.campagnelab.hta.tables.intentions.ApplyGroup_Intention";
  }
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return ListSequence.fromList(SNodeOperations.getDescendants(SNodeOperations.getAncestor(node, "org.campagnelab.hta.tables.structure.Table", false, false), "org.campagnelab.hta.tables.structure.ColumnAnnotation", false, new String[]{})).isNotEmpty();
  }

  public SNodeReference getIntentionNodeReference() {
    return new SNodePointer("r:597299e2-456c-40ec-87e4-c5fdcfc8d153(org.campagnelab.hta.tables.intentions)", "8459500803718255267");
  }
  ...
  private List<Set<String>> parameter(final SNode node, final EditorContext editorContext) {
    ...
    ListSequence.fromList(SNodeOperations.getDescendants(SNodeOperations.getAncestor(node, "org.campagnelab.hta.tables.structure.Table", false, false), "org.campagnelab.hta.tables.structure.ColumnAnnotation", false, new String[]{})).visitAll(new IVisitor<SNode>() {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      for (final String groupName : myParameter) {
        SNode groupRef = SConceptOperations.createNewNode("org.campagnelab.hta.tables.structure.ColumnGroupReference", null);
        SLinkOperations.setTarget(groupRef, "columnGroup", ListSequence.fromList(SModelOperations.getRootsIncludingImported(SNodeOperations.getModel(node), "org.campagnelab.hta.tables.structure.ColumnGroupContainer")).translate(new ITranslator2<SNode, SNode>() {
        ...
        ListSequence.fromList(SLinkOperations.getTargets(AttributeOperations.getAttribute(node, new IAttributeDescriptor.NodeAttribute("org.campagnelab.hta.tables.structure.ColumnAnnotation")), "groups", true)).addElement(groupRef);
      }
    }

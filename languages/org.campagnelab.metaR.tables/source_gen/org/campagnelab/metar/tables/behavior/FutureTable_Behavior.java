...
public class FutureTable_Behavior {
  ...
  public static String call_Rname_772483346259741683(SNode thisNode) {
    return TableTransformation_Behavior.call_RName_772483346259745987(SConceptRepository.getInstance().getConcept(NameUtil.nodeFQName(SConceptOperations.findConceptDeclaration("org.campagnelab.metar.tables.structure.TableTransformation"))), SPropertyOperations.getString(thisNode, "name"));
  }
  ...
  public static void call_setSchemaFrom_4166618652721995042(final SNode thisNode, SNode fsource) {
    ...
    SLinkOperations.setTarget(thisNode, "myOwnTable", SConceptOperations.createNewNode("org.campagnelab.metar.tables.structure.Table", null), true);
    ...
    ListSequence.fromList(SLinkOperations.getTargets(source, "columns", true)).visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
        ...
        AttributeOperations.setAttribute(col, new IAttributeDescriptor.NodeAttribute("org.campagnelab.metar.tables.structure.ColumnAnnotation"), SNodeOperations.copyNode(AttributeOperations.getAttribute(it, new IAttributeDescriptor.NodeAttribute("org.campagnelab.metar.tables.structure.ColumnAnnotation"))));

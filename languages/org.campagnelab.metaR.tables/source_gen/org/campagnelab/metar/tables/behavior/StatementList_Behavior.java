...
public class StatementList_Behavior {
  ...
  public static Scope virtual_getScope_3734116213129936182(SNode thisNode, SNode kind, SNode child) {
    ...
    if (kind == SConceptOperations.findConceptDeclaration("org.campagnelab.metar.tables.structure.FutureTable")) {
      ...
      Iterable<SNode> before = ListSequence.fromList(descendants).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.getIndexInParent(it) < myIndex && SNodeOperations.isInstanceOf(it, "org.campagnelab.metar.tables.structure.FutureTable");
        }
      });

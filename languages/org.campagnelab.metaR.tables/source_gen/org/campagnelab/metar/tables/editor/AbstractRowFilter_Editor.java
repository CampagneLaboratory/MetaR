...
public class AbstractRowFilter_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createComponent_4hi9ny_b0(EditorContext editorContext, SNode node) {
    EditorCell editorCell = editorContext.getCellFactory().createEditorComponentCell(node, "org.campagnelab.metar.tables.editor.AbstractRowFilterEditorComponent");
    return editorCell;
  }

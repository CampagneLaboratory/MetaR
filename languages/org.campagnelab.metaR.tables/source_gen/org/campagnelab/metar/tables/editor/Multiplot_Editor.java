      ...
      public TableModel createTableModel(final SNode node, final EditorContext editorContext) {
        return new TableModel() {
          ...
          public void createElement(int row, int column) {
            ListSequence.fromList(SLinkOperations.getTargets(node, "plots", true)).addElement(SConceptOperations.createNewNode("org.campagnelab.metar.tables.structure.PlotRefWithPreview", null));
          }

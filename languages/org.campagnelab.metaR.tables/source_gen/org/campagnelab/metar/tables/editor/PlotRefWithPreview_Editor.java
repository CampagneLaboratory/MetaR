...
public class PlotRefWithPreview_Editor extends DefaultNodeEditor {
  ...
  public static class _Inline_9p3cny_a0a extends InlineCellProvider {
    ...
    public static class Plot_generic_cellMenu_9p3cny_a0a0a0 extends AbstractCellMenuPart_Generic_Group {
      ...
      public List<?> createParameterObjects(final SNode node, IOperationContext operationContext, EditorContext editorContext) {
        return ListSequence.fromList(SNodeOperations.getDescendants(SNodeOperations.getAncestor(node, "org.campagnelab.metar.tables.structure.Analysis", false, false), "org.campagnelab.metar.tables.structure.Plot", false, new String[]{})).where(new IWhereFilter<SNode>() {
      ...
      public void handleAction_impl(SNode parameterObject, SNode node, SModel model, IOperationContext operationContext, EditorContext editorContext) {
        SNode preview = SNodeFactoryOperations.createNewNode("org.campagnelab.metar.tables.structure.PlotRefWithPreview", null);
  ...
  private static boolean renderingCondition_9p3cny_a1a(SNode node, EditorContext editorContext) {
    return SPropertyOperations.getBoolean(SNodeOperations.getAncestor(node, "org.campagnelab.metar.tables.structure.Multiplot", false, false), "preview");
  }
}

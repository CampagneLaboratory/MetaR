...
public class ImportTable_Constraints extends BaseConstraintsDescriptor {
  public ImportTable_Constraints() {
    super("org.campagnelab.metar.tables.structure.ImportTable");
  }
  ...
  protected Map<String, ReferenceConstraintsDescriptor> getNotDefaultReferences() {
    ...
    references.put("table", new BaseReferenceConstraintsDescriptor("table", this) {
      ...
      public void onReferenceSet(final SNode referenceNode, final SNode oldReferentNode, final SNode newReferentNode) {
        SLinkOperations.setTarget(referenceNode, "future", SConceptOperations.createNewNode("org.campagnelab.metar.tables.structure.FutureTable", null), true);

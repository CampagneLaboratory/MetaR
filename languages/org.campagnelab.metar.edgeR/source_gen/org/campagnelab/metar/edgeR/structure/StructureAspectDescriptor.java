...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 2:
        return new ConceptDescriptorBuilder("org.campagnelab.metar.edgeR.structure.ConstrastsBinaryOperator").super_("org.campagnelab.metar.edgeR.structure.GroupExpression").parents("org.campagnelab.metar.edgeR.structure.GroupExpression").children(new String[]{"left", "right"}, new boolean[]{false, false}).create();
      case 3:

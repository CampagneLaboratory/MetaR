...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 2:
        return new ConceptDescriptorBuilder("org.campagnelab.metar.edgeR.structure.ContrastMinus").super_("org.campagnelab.metar.edgeR.structure.ContrastsBinaryOperator").parents("org.campagnelab.metar.edgeR.structure.ContrastsBinaryOperator").alias("-", "").create();
      case 3:
        return new ConceptDescriptorBuilder("org.campagnelab.metar.edgeR.structure.ContrastsBinaryOperator").super_("org.campagnelab.metar.edgeR.structure.GroupExpression").parents("org.campagnelab.metar.edgeR.structure.GroupExpression").children(new String[]{"left", "right"}, new boolean[]{false, false}).abstract_().create();
      case 4:
      ...
      case 11:
        return new ConceptDescriptorBuilder("org.campagnelab.metar.edgeR.structure.Mean").super_("org.campagnelab.metar.edgeR.structure.GroupExpression").parents("org.campagnelab.metar.edgeR.structure.GroupExpression").children(new String[]{"groups"}, new boolean[]{true}).alias("mean", "consider the estimate of the average in the groups/factor levels").create();
      case 12:
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"org.campagnelab.metar.edgeR.structure.BinaryExpression", "org.campagnelab.metar.edgeR.structure.CommonDispersion", "org.campagnelab.metar.edgeR.structure.ContrastMinus", "org.campagnelab.metar.edgeR.structure.ContrastsBinaryOperator", "org.campagnelab.metar.edgeR.structure.DispersionMethod", "org.campagnelab.metar.edgeR.structure.EdgeRTest", "org.campagnelab.metar.edgeR.structure.GroupExpression", "org.campagnelab.metar.edgeR.structure.GroupFormula", "org.campagnelab.metar.edgeR.structure.GroupRef", "org.campagnelab.metar.edgeR.structure.GroupUsageExpression", "org.campagnelab.metar.edgeR.structure.GroupUsageRef", "org.campagnelab.metar.edgeR.structure.Mean", "org.campagnelab.metar.edgeR.structure.Minus", "org.campagnelab.metar.edgeR.structure.NoIntercept", "org.campagnelab.metar.edgeR.structure.Plus", "org.campagnelab.metar.edgeR.structure.TagWiseDispersion", "org.campagnelab.metar.edgeR.structure.Times", "org.campagnelab.metar.edgeR.structure.TrendedDispersion"};
}
